...
\chapter{Evaluation der Techniken}
	\section{\mi{Ghostlab}}
		...
		Ghostlab kommt von Hause aus mit einer 7-Tage-Testversion. Die Installation verlief einfach und ereignislos. Nachdem das Tool Installiert wurde erfolgte die Zuweisung einer Website zu dem Ghostlabserver. Ich habe  in diesem Fall sowohl eine Seite auf einem lokalen Apache Server getestet, als auch die Demoseite von Ghostlab.
			version 1.2.3 noch kein Master/Slave Modus
			
			
			\met{test}{1}{2}{3}{4}{5}{6}{7}{8}
			\\
	\section{\mi{Adobe Edge Inspect}}
