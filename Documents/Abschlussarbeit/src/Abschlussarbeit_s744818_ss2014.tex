...
{
    name=AJAX,
    description={\z{Kunstwort für Asynchronous JavaScript and XML. Auf JavaScript basierende Technik, die die asynchrone Übertragung von Daten zwischen Client und Server betrifft.}{2}
	}
}
...
{
    name=Javascript,
    description={\z{JavaScript ist eine vielseitige Programmiersprache, mit der sich komplexe Anwendungen entwickeln lassen. Interpreter für JavaScript sind in allen modernen Web-Browsern integriert, daher ist die Sprache erheblich verbreitet. Daneben wird JavaScript zum Scripten einiger populärer Software genutzt. JavaScript wird in der Hauptsache Client-seitig verwendet und es ist damit möglich, auf Webseiten dynamisch Einfluss zu nehmen.}{4}}
}
...
{
    name=Auflösung,
    description={\z{Die Bildauflösung wird oft auch nur als Auflösung bezeichnet.
Sie gibt an, aus wie vielen Bildpunkten (Picture Element (Pixel) [engl.]) ein digitales Fernsehbild besteht.}{5}}
}
...
{
    name=DOM,
    description={\z{Document Object Model (DOM) ist eine plattform- sowie sprachenunabhängige Schnittstellenbeschreibung für den Zugriff auf die Elemente eines HTML- oder XML-Dokuments.}{6}}
}

\newglossaryentry{Apache}
{
    name= Apache,
    description={\z{Software für den Betrieb eines Webservers. Der Apache Server ist meist in der als "LAMP" bezeichneten Kombination aus Linux Betriebssystem, Apache Webserver, MySQL Datenbank und der Programmiersprache PHP installiert.}{7}}
}
...
{
    name= Anker,
    description={\z{Anker oder Sprungmarken sind Elemente, die eine Stelle innerhalb einer Datei markieren.}{8} Diese wird in der Regel durch ein Hashtag (\#) gekennzeichnet}
}
...
\bibitem[WL01]{2} \url{http://wirtschaftslexikon.gabler.de/Definition/ajax.html}
...
\bibitem[ITW01]{4} \url{http://www.itwissen.info/definition/lexikon/JavaScript-JavaScript.html}
\bibitem[DMa]{5}\url{http://www.die-medienanstalten.de/themen/digitale-welt/glossar/erweiterte-erklaerungen/bildaufloesung.html}
\bibitem[ITW02]{6}\url{http://www.itwissen.info/definition/lexikon/document-object-model-DOM.html}
\bibitem[Sumo01]{7}\url{http://www.sumo.de/definition-apache-server.html}
\bibitem[HW01]{8}\url{http://www.html-world.de/205/hyperlinks-und-anker/}
\bibitem[Wiki01]{9}\url{http://de.wikipedia.org/w/index.php?title=Digitales\_Zertifikat\&oldid=129208084}
\bibitem[SeHt01]{10}\url{http://de.selfhtml.org/servercgi/server/htaccess.htm}
\bibitem[Wiki02]{11}\url{http://de.wikipedia.org/w/index.php?title=GNU\_General\_Public\_License
\&oldid=130239300}
\bibitem[Wiki03]{12}\url{http://de.wikipedia.org/w/index.php?title=MIT-Lizenz\&oldid=125762366}
\bibitem[Wiki04]{13}\url{http://de.wikipedia.org/w/index.php?title=Apache-Lizenz\&oldid=130033063}
