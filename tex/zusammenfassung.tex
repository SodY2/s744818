	...
	\begin{table}[H]
		...
		\rowcolors{1}{white}{lightgray}
			...
			\hline
				...
				\hline
				\end{tabular}
			\caption{{\"U}bersicht der Frameworks: GL(Ghostlab), AEI(Adobe Edge Inspect), RP(Remote Preview), B-S(Browser-Sync)}
	\end{table}
...
\\ Ein weiterer Kandidat mit hohem Potential ist Ghostlab, welches zwar schon gute Allroundansätze derzeit vorweisen kann, jedoch leider im Detail nicht ausgereift ist. Die Nachfrage nach einem qualitativ hochwertigem Produkt ist vorhanden, wie es diverse Rezensionen von verschiedenen Fraktionen der Webgemeinde belegen.
